export enum Permissions {
  ...
  // group
  group_management_read = 'group_management_read',
  group_management_create = 'group_management_create',
  group_management_update = 'group_management_update',
  group_management_show = 'group_management_show',
  group_management_delete = 'group_management_delete',
  // note
  note_management_read = 'note_management_read',
  note_management_create = 'note_management_create',
  note_management_update = 'note_management_update',
  note_management_show = 'note_management_show',
  note_management_delete = 'note_management_delete',
}
